...
<form action="/lab5_war_exploded/${url}/create">
    <p>
        ...
        <input class="form-control w-25" type="number" name="tour_number">
    </p>
    <p>
    ...
    <p>
        ...
        <input class="form-control w-25" type="date" name="start_date">
    </p>
    <p>
        <span class="fs-5">End date: </span>
        <input class="form-control w-25" type="date" name="end_date">
    </p>
    <p>

...
<form action="/lab5_war_exploded/${url}/create">
    <p>
        ...
        <input class="form-control w-25" type="number" name="flight_code">
    </p>
    <p>
        <span class="fs-5">Air company: </span>
        <input class="form-control w-25" type="text" name="air_company">
    </p>
    <p>
        <span class="fs-5">Departure date: </span>
        <input class="form-control w-25" type="date" name="departure_date">
    </p>
    <p>
        <span class="fs-5">Departure time: </span>
        <input class="form-control w-25" type="time" name="departure_time">
    </p>
    <p>
        <span class="fs-5">Arrival city: </span>
        <input class="form-control w-25" type="text" name="arrival_city">
    </p>
    <p>
        <span class="fs-5">Departure city: </span>
        <input class="form-control w-25" type="text" name="departure_city">
    </p>
    <p>
        <span class="fs-5">Directions: </span>
        <input class="form-control w-25" type="text" name="directions">
    </p>
    <p>
